<div class="w-full">
    <nav class="flex gap-2 items-center">
        ...
        <a href="{{ route('abonos.index') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-600 dark:hover:text-gray-200 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
            Abonos
        </a>
