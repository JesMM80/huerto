<div>
    <button wire:click="$emit('alertBorraFamilia',{{$familia->id}})">
    ...
    @push('sweetAlertScript')
        ...
        <script>
            ...
            livewire.on('alertBorraFamilia', function(familiaId) {

                Swal.fire({
                    title: 'Estás seguro?',
                    text: "Se eliminará la familia!"+familiaId,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        Livewire.emit('borraFamilia',familiaId);
                        Swal.fire(
                        'Eliminada!',
