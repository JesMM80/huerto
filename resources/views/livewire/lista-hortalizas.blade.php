    ...
    <div class="w-full bg-green-100 border border-gray-500 grid grid-cols-3">
        @foreach ($hortalizas as $hortaliza)
            ...
            <div class="p-2 flex items-center justify-center hover:bg-green-300 ">
                <form action="{{ route('hortalizas.destroy',$hortaliza->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
                    <button type="submit">
                ...
                <a href="{{ route('hortalizas.edit',$hortaliza) }}" class="" alt="editar familia">
