<div>
    <div class="w-full mx-auto p-1 lg:p-1 mt-5 mb-5">
        ...
        <div class="shadow-2xl shadow-gray-500/20 p-6 bg-white dark:bg-gray-700/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent rounded-lg motion-safe:hover:scale-[1.01] transition-all duration-250">
            <form wire:submit.prevent='edicionCosecha'>
                @csrf  
                @method('PUT')
                <div class="grid grid-cols-2 gap-2">
                    <div class="w-full mb-2">
                        ...
                        <select wire:model="hortaliza" class="w-full border border-indigo-500 rounded p-2">
                            @foreach ($hortalizas as $hortaliza)
                                <option value="{{$hortaliza->id}}"> 
                    ...
                    <div class="w-full mb-2">
                        ...
                        <select wire:model="zona" class="w-full border border-indigo-500 rounded p-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="w-full mb-2">
                        ...
                        <input 
                            ...
                            wire:model="usuario" 
                            disabled
                            value="{{old('usuario',$cosecha->user->name)}}">
                    </div>
                </div>
